...
──────────────────────────────────────────────────────────────────────────────────── 
created by Dallas-md 🕵
contact me 237699586756 ♻️
© Copy coder alert ⚠
*/
...
const ownerNumber = ['237699586756']
...
let up = `*╭──────────────●●►*
> *➺Dallas-md ᴄᴏɴɴᴇᴄᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʏ ᴛʏᴘᴇ .ᴍᴇɴᴜ ᴛᴏ ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ ᴄʀᴇᴀᴛᴇᴅ ✅*

> *❁ᴊᴏɪɴ ᴏᴜʀ ᴡʜᴀᴛsᴀᴘᴘ ᴄʜᴀɴɴᴇʟ ғᴏʀ ᴜᴘᴅᴀᴛᴇs Dallas-md❁*
...
*╭⊱✫🔮 Dallas-md🔮✫⊱╮*
*│✫➠ - 📂REPOSITORY NAME:* *Dallas-md*
*│✫➠ - 📃DESCRIPTION:* *THE WORLD BEST WHATSAPP BOT♻️*
*│✫➠ - 🛡️OWNER:* *Dallad-md*
*│✫➠ - 🌐URL:* *https://github.com/Sukuna-ZO/Dallas-md*
...
app.get("/", (req, res) => {
res.send("HEY, Dallas-md STARTED ✅");
});
